...
#ifdef CONFIG_ANDROID_BINDER_DEVICES
#undef CONFIG_ANDROID_BINDER_DEVICES
#endif
 ...
 *                        in binder_open()
 *                        (invariant after initialized) // #if ((LINUX_VERSION_CODE >= KERNEL_VERSION(5,4,162)) && (LINUX_VERSION_CODE < KERNEL_VERSION(5,5,0)))
...
#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(5,4,162)) && (LINUX_VERSION_CODE < KERNEL_VERSION(5,5,0)))
						...
						struct flat_binder_object *fp)
{
	...
	node->txn_security_ctx = false; //!!(flags & FLAT_BINDER_FLAG_TXN_SECURITY_CTX);
					      ...
					      bool is_failure)
{
    ...
    ((LINUX_VERSION_CODE >= KERNEL_VERSION(5,4,162)) && (LINUX_VERSION_CODE < KERNEL_VERSION(5,5,0)))
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,15,12)
